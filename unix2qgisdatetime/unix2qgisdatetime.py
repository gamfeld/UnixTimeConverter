...
class UnixTimeConverter:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'UnixTimeConverter_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Convert Unix Time')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('UnixTimeConverter', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/unix2qgisdatetime/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Format Unix Time'),
            callback=self.run,
